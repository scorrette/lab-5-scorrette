...
#
# Generated by Vivado on Sat Apr 10 00:21:07 -0400 2021
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/GitHub/lb5-its-all-about-the-processors/lb5-its-all-about-the-processors.cache/compile_simlib/activehdl"
  fi
